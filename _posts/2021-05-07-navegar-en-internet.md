...
Así, nuestra realidad no se puede separar entre lo que vivimos en digital y el mundo "real". Este concepto es fundamental para descubrir los puntos de contacto que tenemos con los consumidores.

Antes de esta locura, los encontrábamos cautivos frente a un televisor, escuchando radio o leyendo un periódico. Hoy tratamos de hacer predicciones para entender en cuál medio podremos capturar algunos segundos de su atención. Y aunque una buena parte de la lógica en el uso de medios para publicidad se mantiene, el concepto de audiencias ofrece nuevos retos.

En este panorama en el que el viaje del consumidor está cada vez más fragmentado, ¿qué pueden hacer los negocios para establecer puntos de contacto en medios de comunicación? Algunas ideas:

- Tener un propósito.
- Por lo menos entender dónde empieza el ciclo del consumidor.
- Definir las etapas de venta del producto y servicio, para saber qué tipo de mensajes y medios utilizar.
- Comprender las nuevas dinámicas de creación de contenidos.
- Optimizar medios propios que logren generar datos una vez que los consumidores lleguen.
- Y la más importante: usar todo lo que esté al alcance para conocer al consumidor.

Y ahora podemos seguir *navegando*.
